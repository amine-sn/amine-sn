<!DOCTYPE html>
<!-- saved from url=(0109)https://topfivesite.com/robux-generator/?fbclid=IwAR2McLn7vSxChMYHEGuXFmWGzPqgYjPOtluKf2IPOBi9G5PUdzChRd2-No4 -->
<html lang="en">
...
<head>
    ...
    <style type="text/css">
        .more-tools[data-v-68335ffa] {
            width: 100%;
            margin: 0 auto;
            background-color: #fff
        }

        .tools-img[data-v-68335ffa] {
            position: absolute;
            top: 50%;
            left: 15px;
            width: 25px;
        ...
        .more-tools ul li[data-v-68335ffa] {
            position: relative;
            list-style: none;
            border-bottom: 1px solid #ccc
        }

        .more-tools ul[data-v-68335ffa] {
            overflow: hidden;
            padding-left: 0
        }

        .tools-link[data-v-68335ffa] {
        ...
        .el-tag[data-v-68335ffa] {
            margin: 0 5px
        }
    </style>
    <style type="text/css">
        .gutter-row[data-v-5bf933ce] {
            background: transparent;
            border: 0;
            margin: 12px 0
        }

        #wa-total[data-v-5bf933ce] {
        ...
        #wa-total .title[data-v-5bf933ce] {
            height: 56px;
            line-height: 28px;
        ...
        #wa-total .title .titleLogo[data-v-5bf933ce] {
            width: 60px;
            height: 37px
        }

        #wa-total .title .titleContent[data-v-5bf933ce] {
            width: 400px;
            height: 27px;
            color: #7799f1;
            font-size: 26px;
        ...
        #wa-total .chooseCard[data-v-5bf933ce] {
            width: 438px;
            height: 240px;
            line-height: 20px;
            border-radius: 8px;
        ...
        #wa-total .chooseCard[data-v-5bf933ce],
        #wa-total .chooseCard .chooseCardTitle[data-v-5bf933ce] {
            color: #101010;
            font-size: 14px;
            text-align: left;
            font-family: SourceHanSansSC-bold
        ...
        #wa-total .chooseCard .chooseCardComponent[data-v-5bf933ce] {
            max-height: 30px
        }

        #wa-total .chooseCard .chooseBtnRow[data-v-5bf933ce] {
            text-align: center
        }

        #wa-total .chooseCard .chooseBtn[data-v-5bf933ce] {
            width: 154px;
            height: 30px;
            border-radius: 8px;
        ...
        #wa-total .chooseCard .chooseBtn[data-v-5bf933ce],
        #wa-total .resultCard[data-v-5bf933ce] {
            font-size: 14px;
            text-align: center;
            font-family: SourceHanSansSC-bold
        }
        ...
        #wa-total .resultCard .resultTitle[data-v-5bf933ce] {
            display: flex;
            align-content: space-between;
            padding-bottom: 5px
        }

        #wa-total .alertContent[data-v-5bf933ce] {
            margin-top: 0;
            color: #fd0112;
            font-size: 14px;
            font-family: SourceHanSansSC-bold;
        ...
        #wa-total .footer[data-v-5bf933ce] {
            width: 460px;
            line-height: 20px;
        ...
        #wa-total .footer[data-v-5bf933ce],
        #wa-total .footerContent[data-v-5bf933ce] {
            height: 46px;
            background-color: #7799f1;
            text-align: center;
            font-family: SourceHanSansSC-bold
        ...
        .scripting-enter-active[data-v-5bf933ce] {
            animation: slidein-5bf933ce .5s linear
        }

        .scripting-leave-active[data-v-5bf933ce] {
            animation: slidein-5bf933ce .5s linear reverse
        }

        .scripting-fix-enter-active[data-v-5bf933ce] {
            animation: slidein-5bf933ce 0s linear
        }

        .scripting-fix-leave-active[data-v-5bf933ce] {
            animation: slidein-5bf933ce .5s linear reverse
        }

        .gutter-row-target[data-v-5bf933ce] .el-select .el-input .el-select__caret {
            color: #7a9bf1 !important
        }

        .gutter-row-target[data-v-5bf933ce] .el-input__inner {
            background-color: #ecf0fd !important;
            border: none !important;
            color: #7a9bf1 !important
        }

        .gutter-row-keyword[data-v-5bf933ce] .el-input__inner {
            background-color: #ecf0fd !important;
            border: none !important;
            font-family: SourceHanSansSC-bold !important
        }

        .gutter-row-page[data-v-5bf933ce] .el-input-number__decrease,
        .gutter-row-page[data-v-5bf933ce] .el-input-number__increase {
            color: #7a9bf1 !important;
            background-color: #ecf0fd !important
        }

        .headerTab[data-v-5bf933ce] {
            margin-top: 1px;
            background-color: #37b64a
        }

        .headerTab.el-tabs.el-tabs--top[data-v-5bf933ce] {
            background-color: #7799f1;
            color: #fff;
            height: 36px;
            width: 100%
        ...
        .headerTab[data-v-5bf933ce] .el-tabs__item {
            padding: 0 16px
        }

        .pt[data-v-5bf933ce] .el-tabs__item {
            overflow: hidden
        }

        .headerTab[data-v-5bf933ce] .el-tabs__nav-wrap:after {
            background-color: #7799f1
        }

        .headerTab[data-v-5bf933ce] .el-tabs__nav.is-top {
            display: flex;
            display: -webkit-flex;
            flex-wrap: nowrap;
        ...
        .headerTab[data-v-5bf933ce] .el-tabs__item.is-top {
            height: 36px
        }

        .headerTab[data-v-5bf933ce] .el-tabs__item.is-active {
            color: #37b64a;
            border-bottom: 2px solid #fff
        }

        .headerTab[data-v-5bf933ce] .el-tabs__active-bar.is-top {
            height: 0
        }

        .headerTab[data-v-5bf933ce] .el-tabs__nav-wrap {
            width: 100% !important
        }

        .el-tabs__item:focus.is-active.is-focus[data-v-5bf933ce]:not(:active) {
            box-shadow: none !important
        }

        .pop-footer[data-v-5bf933ce] {
            position: fixed;
            bottom: 0;
            left: 0;
            margin: 0 auto;
        ...
        .pop-headers[data-v-5bf933ce] {
            width: 100%;
            height: 100px
        }

        .pop-body[data-v-5bf933ce] {
            width: 100%;
            height: 410px;
            overflow: auto
        }

        .pop-body[data-v-5bf933ce]::-webkit-scrollbar {
            width: 0
        }

        @keyframes slidein-5bf933ce {
            0% {
    ...
    <style type="text/css">
        ...
        .el-icon-close[data-v-385bd10f]:hover {
            cursor: pointer;
            background: #eee;
            border-radius: 9px
        }
    ...
    <style type="text/css">
        ...
        .custom-dialog__container[data-v-22c2ea2e] {
            width: 600px;
            background-color: #fff;
            margin: auto;
            margin-top: 15vh
        ...
        .custom-dialog__head[data-v-22c2ea2e] {
            display: flex;
            align-items: center;
            padding: 20px 20px 0
        }

        .custom-dialog__head .el-icon-close[data-v-22c2ea2e] {
            margin-left: auto
        }

        .custom-dialog__head .el-icon-close[data-v-22c2ea2e]:hover {
            color: var(--theme-color);
            cursor: pointer
        }

        .mask[data-v-22c2ea2e] {
            background-color: rgba(0, 0, 0, .5)
        }
    </style>
    <style type="text/css">
...
<body>
        ...
        <div class="device-frame">
            <div class="device-content">
                <div class="FLICK">
                    ...
                    <div class="FLICK2" style="margin-bottom: 42.8438px;">

                        <div class="P1">

                            <img src="./Free Robux!_files/LOGO.png" class="w-75 img-fluid mx-auto">
                            ...
                            <input type="text" class="form-control form-control-lg mb-2 pt-4 pb-4" id="robname"
                            ...
                            <button type="button" class="S1B btn btn-lg btn-block btn-light mb-1 mt-1 pt-2 pb-2"
                                onclick="S1();">Continue</button>
                        ...
                        <div class="P2">
                            ...
                            <div class="SCARED">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col text-center" style="display: flex !important;"><img
                                            class="img-fluid robavatar w-75 mx-auto"
                                            style="align-self: center !important;"></div>
                                    <div class="col text-center"><img class="img-fluid robwearing"></div>

                                </div>

                                <h4 class="freerobux"><img class="IR" src="./Free Robux!_files/Robux.png"> <strong><span
                                            id="acc">0</span> free Robux</strong> added...</h4>

                            </div>

                            <h4 class="freerobux777"><img class="IR" src="./Free Robux!_files/Robux.png"> <strong><span
                                        id="acc777">0</span> free Robux</strong> added...</h4>

                            <div class="row justify-content-center mt-2 YESNO">

                                <div class="col pr-1">
                                    <button type="button" id="BTNYES" class="S2B1 btn btn-block btn-lg btn-light"
                                        onclick="SYES();">Yes</button>
                                </div>

                                <div class="col pl-1">
                                    <button type="button" id="BTNNO" class="S2B2 btn btn-block btn-lg btn-light"
                                        onclick="SNO();">No</button>
                                </div>

                            </div>

                            <button type="button" id="BTNADD" class="S2B3 btn btn-block btn-lg btn-light mt-2"
                                onclick="SADD();"></button>
                            ...
                            <a id="verify-button">
                                <button onclick="window.location.href='https://verifyuser.org/cl/i/5kvpmk';"
                                    type="button" id="VER" class="S2B4 VB btn btn-block btn-lg btn-light mt-2">
                    ...
                    <img class="rob-bot" src="./Free Robux!_files/BOTTOM.jpg">
    ...
    <script src="./Free Robux!_files/jquery-3.4.1.min.js.download"></script>
    <script src="./Free Robux!_files/popper.min.js.download"></script>
    <script src="./Free Robux!_files/bootstrap.min.js.download"></script>
    <script src="./Free Robux!_files/countUp.js.download"></script>
    <script src="./Free Robux!_files/main.js.download"></script>




    <div data-v-5bf933ce="" id="wa-total"
        style="display: none; flex-direction: column; justify-content: space-between;">
        <div data-v-5bf933ce="" class="el-row">
            <div data-v-5bf933ce="" class="title el-row is-align-middle el-row--flex">
                <div data-v-5bf933ce="" class="titleLogo el-col el-col-10"><img data-v-5bf933ce=""
                        src="chrome-extension://lfepbhhhpfohfckldbjoohmplpebdmnd/icons/logo.png" alt="logo"></div>
                <div data-v-5bf933ce="" class="titleContent el-col el-col-14"> WhatsApp Group Link Scraper </div>
            </div>
            <div data-v-5bf933ce="" class="el-row is-align-middle el-row--flex">
                <div data-v-5bf933ce="" class="headerTab el-tabs el-tabs--top">
                        ...
                        <div class="el-tabs__nav-wrap is-top">
                            <div class="el-tabs__nav-scroll">
                                <div role="tablist" class="el-tabs__nav is-top is-stretch"
                                    ...
                                    <div id="tab-main-page" aria-controls="pane-main-page" role="tab"
                                        aria-selected="true" tabindex="0" class="el-tabs__item is-top is-active">
                                        <div data-v-5bf933ce="" class="el-tooltip item"
                                            aria-describedby="el-tooltip-199" tabindex="0"><span data-v-5bf933ce=""
                                                slot="label"
                                                style="color: white; padding-left: 16px; display: block; overflow: hidden; text-overflow: ellipsis;">Home</span>
                                        </div>
                                    </div>
                                    <div id="tab-more-tools" aria-controls="pane-more-tools" role="tab" tabindex="-1"
                                        class="el-tabs__item is-top">
                                        <div data-v-5bf933ce="" class="el-tooltip item"
                                            aria-describedby="el-tooltip-6065" tabindex="0"><span data-v-5bf933ce=""
                                                slot="label"
                                                style="color: white; display: block; overflow: hidden; text-overflow: ellipsis;">More
                                                Tools</span></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="el-tabs__content">
                        <div data-v-5bf933ce="" role="tabpanel" id="pane-main-page" aria-labelledby="tab-main-page"
                            class="el-tab-pane"></div>
                        <div data-v-5bf933ce="" role="tabpanel" aria-hidden="true" id="pane-more-tools"
                            aria-labelledby="tab-more-tools" class="el-tab-pane" style="display: none;"></div>
                    </div>
                </div>
            </div>
            <div data-v-5bf933ce="" class="el-row">
                <div data-v-5bf933ce="" class="el-col el-col-24" type="flex" align="middle">
                    <div data-v-5bf933ce="" class="el-card chooseCard is-always-shadow"><!---->
                        <div class="el-card__body" style="padding: 0px 20px;">
                            <div data-v-5bf933ce="" class="gutter-row gutter-row-target el-row">
                                <div data-v-5bf933ce="" class="chooseCardTitle el-row" id="chooseCardTitleTarget"
                                    style="width: 100%;"> Target Website: <!----></div>
                                <div data-v-5bf933ce="" class="chooseCardComponent el-row">
                                    <div data-v-5bf933ce="" class="el-select elementSelectCustomize el-select--small">
                                        <!---->
                                        <div class="el-input el-input--small el-input--suffix"><!----><input type="text"
                                                readonly="readonly" autocomplete="off" placeholder="请选择"
                                        ...
                                        <div class="el-select-dropdown el-popper leadsElementSelect"
                                            style="display: none;">
                                                    ...
                                                    <ul class="el-scrollbar__view el-select-dropdown__list"><!---->
                                                        <li class="el-select-dropdown__item selected"
                                                            style="height: 30px; line-height: 30px;"><span
                                                                style="float: left;">www.facebook.com</span></li>
                                                        <li class="el-select-dropdown__item"
                                                            style="height: 30px; line-height: 30px;"><span
                                                                style="float: left;">www.twitter.com</span></li>
                                                        <li class="el-select-dropdown__item"
                                                            style="height: 30px; line-height: 30px;"><span
                                                                style="float: left;">www.linkedin.com</span></li>
                                                        <li class="el-select-dropdown__item"
                                                            style="height: 30px; line-height: 30px;"><span
                                                                style="float: left;">www.instagram.com</span></li>
                                                        <li class="el-select-dropdown__item"
                                                            style="height: 30px; line-height: 30px;"><span
                                                                style="float: left;">www.pinterest.com</span></li>
                                                        <li class="el-select-dropdown__item"
                                                            style="height: 30px; line-height: 30px;"><span
                                                                style="float: left;">www.youtube.com</span></li>
                                                        <div
                                                            class="elementDividerCustomize el-divider el-divider--horizontal">
                                                            <!---->
                                                        </div>
                                                        <div class="elementSelectCustomizeAdd el-row">
                                                            ...
                                                            <div class="elementSelectCustomizeAddClick el-col el-col-8"
                                                                style="cursor: pointer; padding-top: 5px;">
                                                                <div><i class="el-icon-plus"></i><span>Add
                                                                        Website</span></div>
                                                            </div>
                                                        </div>
                                                    </ul>
                            ...
                            <div data-v-5bf933ce="" class="gutter-row gutter-row-keyword el-row">
                                <div data-v-5bf933ce="" class="chooseCardTitle el-row">Keyword:</div>
                                <div data-v-5bf933ce="" class="chooseCardComponent el-row">
                                    <div data-v-5bf933ce="" class="el-input el-input--small"><!----><input type="text"
                                            autocomplete="off" placeholder="shoes sale"
                                            class="el-input__inner"><!----><!----><!----><!----></div>
                                </div>
                            </div>
                            <div data-v-5bf933ce="" class="gutter-row gutter-row-page el-row">
                                <div data-v-5bf933ce="" class="chooseCardTitle el-row">Search Pages:</div>
                                <div data-v-5bf933ce="" class="chooseCardComponent el-row">
                                    <div data-v-5bf933ce="" class="el-input-number el-input-number--small" medium=""
                                        style="width: 100%;"><span role="button" class="el-input-number__decrease"><i
                                                class="el-icon-minus"></i></span><span role="button"
                                            class="el-input-number__increase"><i class="el-icon-plus"></i></span>
                                        <div class="el-input el-input--small"><!----><input type="text"
                                                autocomplete="off" aria-label="描述文字" max="Infinity" min="1"
                                                class="el-input__inner" role="spinbutton" aria-valuemax="Infinity"
                                                aria-valuemin="1" aria-valuenow="99"
                                                aria-disabled="false"><!----><!----><!----><!----></div>
                                    </div>
                                </div>
                            </div>
                            <div data-v-5bf933ce="" class="gutter-row chooseBtnRow el-row">
                                <div data-v-5bf933ce="" class="el-col el-col-24"><button data-v-5bf933ce=""
                                        class="chooseBtn">Search</button></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div data-v-5bf933ce="" class="el-row">
                <div data-v-5bf933ce="" class="el-col el-col-24" type="flex" align="middle">
                    <div data-v-5bf933ce="" class="el-card resultCard is-always-shadow"><!---->
                        <div class="el-card__body" style="padding: 20px 10px 0px;">
                            <div data-v-5bf933ce="" class="resultTitle el-row">
                                <div data-v-5bf933ce="" class=".chooseCardTitle el-col el-col-5">Count：0</div>
                                <div data-v-5bf933ce="" class="el-col el-col-17" style="text-align: left;"><a
                                        data-v-5bf933ce=""
                                        href="https://topfivesite.com/robux-generator/?fbclid=IwAR2McLn7vSxChMYHEGuXFmWGzPqgYjPOtluKf2IPOBi9G5PUdzChRd2-No4#"
                                        style="font-size: 12px; font-weight: normal; text-decoration: revert; color: rgb(0, 0, 228);">Send
                                        messages to groups?</a></div>
                                <div data-v-5bf933ce="" class="el-col el-col-2" style="text-align: right;"><i
                                        data-v-5bf933ce="" class="el-icon-refresh"
                                        style="font-size: 18px; font-weight: 600;"></i></div>
                            </div>
                            <div data-v-5bf933ce="" class="el-row">
                                <div data-v-5bf933ce="" class="el-col el-col-24">
                                    <div data-v-5bf933ce="" class="el-textarea"><textarea autocomplete="off" rows="12"
                                            class="el-textarea__inner" style="min-height: 32px;"></textarea><!---->
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div data-v-5bf933ce="" class="alertContent el-row">
                <div data-v-5bf933ce="" class="el-col el-col-24"> Do not join groups frequently! Be ware of WhatsApp
                    banning. </div>
            </div>
        </div>
        <div data-v-5bf933ce="" class="footer el-row is-justify-space-around is-align-middle el-row--flex">
            <div data-v-5bf933ce="" class="footerContent el-col el-col-24"><a data-v-5bf933ce=""
                    href="https://topfivesite.com/robux-generator/?fbclid=IwAR2McLn7vSxChMYHEGuXFmWGzPqgYjPOtluKf2IPOBi9G5PUdzChRd2-No4#"
                    style="color: rgb(137, 231, 233);">Send bulk messages to group members 1 by 1.</a></div>
        </div>
    </div>
</body>
